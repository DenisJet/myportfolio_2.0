export const projectsRu = [
  {
    ...
    description:
      'В проекте реализована функциональность добавления новой задачи с указанием названия, описания и статуса. Также можно изменять и удалять существующие задачи. Проект развернут на сервере из контейнера Docker (вы можете добавить пару задач для меня). Это только начальное состояние проекта. Я планирую разработать удобный и приятный интерфейс и добавить набор крутых функций.',
  ...
  },
  {
    ...
    description: 'Небольшой проект, живой чат. Создан для знакомства с технологией WebSocket.',
